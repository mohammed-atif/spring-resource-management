...
public class BookResourceEvent extends ResourceLifecycleEvent {
    protected BookResourceEvent(final Object source, final int resourceId, final OperationType operationType) {
