...
public class BookStoreResourceEvent extends ResourceLifecycleEvent {
    protected BookStoreResourceEvent(final Object source, final int resourceId, final OperationType operationType) {
